...
int lengths[] = {100, 100, 100}; // 3DOF arm where shoulder to elbow is 225mm, elbow to wrist is 150mm and wrist to end effector is 100mm.
...
void loop() {
  ...
  fabrik2D.solve2(100, 0, 100, -M_PI/2.5, 0, lengths);
